...
class Level:
    ...
    def setup(self, tmx_map, level_frames, audio_files):
        ...
        # hitbox
        for obj in tmx_map.get_layer_by_name('Hitbox'):
           if obj.name in ('hitbox_saw','hitbox_floor_spike'):
                Sprite(pos=(obj.x, obj.y), groups=self.damage_sprites, z = Z_LAYERS['hb'])
        ...
        for obj in tmx_map.get_layer_by_name('Objects'):
            ...
            if obj.name == 'flag':
                self.data.level_number = obj.properties['change_level']
    ...
    def create_pearl(self, pos, direction):
        Pearl(pos, (self.all_sprites, self.damage_sprites, self.pearl_sprites), self.pearl_surf, direction, 500)
